...
import { crearResolucion,actualizarResolucion,eliminarResolucion,obtenerPeriodos, leerResolucion, buscarResoluciones, activarResolucion, desactivarResolucion } from '../controllers/resoluciones.controller.js'
const router = Router();
